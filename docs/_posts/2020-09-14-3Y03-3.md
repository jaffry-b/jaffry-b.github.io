...
- Multiplication Rule
    ...
    - n $_{1}$=n$_{2}$=2
    - \# of outcomein this sample sapce is n$_{1}$ x n$_{2}$ = 1
...
- Permutations, Combinations
    ...
    - If it is an undordered arrangement: **Combinations**
    ...
    - Ex: Assume a batch of 75 semi-conductors. 70 are standard, 5 are not standard.
        ...
        - Could have 1,0,2,3 non standard. 
            - N objects, select r from them with unordered arrangments
            - r=3, n=75
            -  ![img]({{site.url}}/assets/y5.png)
        - b). number of selections with exactly 2 confrom chups