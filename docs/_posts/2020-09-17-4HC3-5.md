...
layout: post
title:  "4HC3 LEC5"
date:   2020-09-17 00:00:00-0400
categories: 4HC3
---
#  SE 4HC3 - Human Computer Interfaces 
**_September 17th 2020_** Lecture 5
---
---
**Task Analysis**
...
- The following characteristics are very important to task analysis
    ...
    - **Tasks**: A goal-directed behavior or series of behaviors involving the UI
        ...
        - For tasks and subtasks, a task could be searching the store for products, and subtasks could be filter search by category, filter by sales, sort by lowest to highest price, sort by highest to lowest
...
- **Design thinking** is a design process and set of related tools for creative problem solving
    ...
    ![img]({{ site.url }}/assets/hc19.png)  
    ![img]({{ site.url }}/assets/hc20.png)  
