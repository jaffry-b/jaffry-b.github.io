...
**Markovian Property**
    - Markovian Proprerty - the conditional distribution of any future state X$_{n+1}$, given past states X$_{0}$, X$_{1}$.... X$_{n-1}$ and the present state X$_{n}$ is independent of past states and depends only on the present state X$_{n}$
